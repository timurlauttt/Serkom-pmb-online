...
@section('page-description', 'Buat profile sekolah baru')

@section('content')
<div class="max-w-4xl">
    <form id="profileForm" action="{{ route('admin.profiles.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        @csrf
...
<script>
// Dynamic add/remove for missions and facilities
(function(){
    ...
    // Prefill from old inputs if present (server-rendered values available via blade)
    ...
    if (Array.isArray(oldFacilities) && oldFacilities.length > 0) {
        // handle if oldFacilities is array of strings or array of arrays/objects
