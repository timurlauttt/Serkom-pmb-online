...
@section('page-description', 'Buat data paket wisata baru')
        ...
        <form action="{{ route('admin.paket-wisata.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <input type="text" name="nama_paket" id="nama_paket" value="{{ old('nama_paket') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('nama_paket') border-red-500 @enderror" required>
                    @error('nama_paket')
                ...
                <div>
                    ...
                    <input type="text" name="kategori" id="kategori" value="{{ old('kategori') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('kategori') border-red-500 @enderror" placeholder="Contoh: Wisata Keluarga, Wisata Edukasi, dll" required>
                    @error('kategori')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" name="durasi_hari" id="durasi_hari" value="{{ old('durasi_hari') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('durasi_hari') border-red-500 @enderror" min="1" required>
                    @error('durasi_hari')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('harga') border-red-500 @enderror" min="0" required>
                    @error('harga')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    @php
                    $oldObjekWisata = old('objek_wisata', ['']);
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="6" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('keterangan') border-red-500 @enderror">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
