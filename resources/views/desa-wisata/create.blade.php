...
@section('title', 'Tambah Desa Wisata')
@section('page-title', 'Tambah Desa Wisata')
@section('page-description', 'Buat data desa wisata baru')

@section('content')
<div class="max-w-4xl">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.desa-wisata.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
