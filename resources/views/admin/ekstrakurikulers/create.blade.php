...
@section('page-description', 'Buat ekstrakurikuler baru')
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="icon" id="icon" value="{{ old('icon', 'fas fa-star') }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="pembina" id="pembina" value="{{ old('pembina') }}" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="jadwal" id="jadwal" value="{{ old('jadwal') }}" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="6" 
                              ...
                              placeholder="Deskripsi ekstrakurikuler..." required>{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div id="tagsContainer">
                        @php $tags = old('tags', []); if(is_string($tags)) $tags = json_decode($tags, true) ?: []; @endphp
